...
#define COLOR_BLUE [UIColor colorWithHexString:@"#0089E6"]
...
#define NOTICE_SERVICE_REFERSH @"NOTICE_SERVICE_REFERSH"//
#define NOTICE_WHISTLE_REFERSH @"NOTICE_WHISTLE_REFERSH"//
#define NOTICE_WORK_NOTICE_REFERSH @"NOTICE_WORK_NOTICE_REFERSH"//
#define NOTICE_CERT_NOTICE_REFERSH @"NOTICE_CERT_NOTICE_REFERSH"//
