...
- (void)requestDisposal{
    ...
    [RequestApi requestDisposalWhistleWithResult:self.textView.text areaId:0 id:self.model.iDProperty scope:nil scopeId:0 delegate:self success:^(NSDictionary * _Nonnull response, id  _Nonnull mark) {
