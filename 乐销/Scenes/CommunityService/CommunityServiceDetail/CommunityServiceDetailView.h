...
@interface CommunityServiceDetailTopView : UIView
...
@interface CommunityServiceDetailStatusView : UIView
//属性
...
@interface CommunityServiceDetailAddCommentView : UIView
//属性
...
@interface CommunityServiceDetailCommentDetailView : UIView
//属性
@property (strong, nonatomic) UILabel *comment;
@property (strong, nonatomic) UILabel *satisfaction;
@property (strong, nonatomic) UILabel *content;
...
@interface CommunityServiceDetailDisposaView : UIView
//属性
