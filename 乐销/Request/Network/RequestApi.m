...
+ (NSString *)replaceParameter:(NSDictionary *)dicParameter url:(NSString *)URL{
   ...
   NSNumber * num =  [dicParameter numberValueForKey:@"scope"];
    ...
    NSNumber * scopeId =  [dicParameter numberValueForKey:@"scopeId"];
    if (scopeId.doubleValue) {
        strReturn = [strReturn appendUrl:[NSString stringWithFormat:@"%@",scopeId] key:@"scopeId"];
    }
